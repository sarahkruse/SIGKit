function [hour,Fraw,Diff,X,Y]=tester_GEM_read_g(filename);
...
% . convert hr-min-sec to decimal hour
 ...
 subplot(3,2,4); scatter(X,Y,50,Fraw/1000,'filled'); axis image; colorbar;
 title('raw total field [10^3 nT]');
 subplot(3,2,5); scatter(X,Y,50,Diff,'filled'); axis image; colorbar;
